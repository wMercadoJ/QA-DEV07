...
Feature: Get comments from a Story
  ...
  @list_comments @get_comment @smoke
  ...
  @ID_value  @story_id @person_id @get_comment @functional
  ...
  @Kind_value @text_value @get_comment @functional @comment_characters
  ...
  @created_at_value @updated_at_value @get_comment
  ...
  @id_invalid @negative @get_comment
